...
public class Camera2VideoFragment extends Fragment
    ...
    private String getVideoFilePath(Context context) {
        final String saveDir = "TeacherTalk";
        File saveTo = new File(context.getExternalFilesDir(
                Environment.DIRECTORY_PICTURES), saveDir);
        final File dir = context.getExternalFilesDir(null);
        //return (dir == null ? "" : (dir.getAbsolutePath() + "/"))
        return (saveTo + "/") + System.currentTimeMillis() + ".mp4";
    }
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mButtonVideo.setColorFilter(Color.RED);
    ...
    private void stopRecordingVideo() {
        ...
        mButtonVideo.setColorFilter(Color.WHITE);
        // Stop recording
        mMediaRecorder.stop();
